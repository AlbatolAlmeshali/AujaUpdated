...
//                        .fontWeight(.bold)
                ...
                VStack(alignment: .center, spacing: 20) {
                    Text("6 out of 10")
                        ...
                        .fontWeight(.heavy)
                    Text("What is the name of the most famous race in Saudi Arabia that is held annually?")
                        .font(.system(size: 20))
                        .bold()
                        .foregroundColor(.gray)
                    
                    AnswerRow(answer: Answer(text: "Camel racing", isCorrect: true))
                    AnswerRow2(answer: Answer(text: "Car racing", isCorrect: false))
                    AnswerRow3(answer: Answer(text: "Cano sprint", isCorrect: false))
                    AnswerRow4(answer: Answer(text: "Volley ball", isCorrect: false))
                }
            }
            .padding()
...
//            .background(Color.white)
            ...
            .background(
                NavigationLink("", destination: QuestionView7(), isActive: $navigateToQuestion2)
            )
