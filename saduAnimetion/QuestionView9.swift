...
//                        .fontWeight(.bold)
                ...
                ProgressBar(progress: 315)
                VStack(alignment: .center, spacing: 20) {
                    Text("9 out of 10")
                        .foregroundColor(Color("AccentColor"))
                        .fontWeight(.heavy)
                    Text("What is the name of the current king?")
                        .font(.system(size: 20))
                        .bold()
                        .foregroundColor(.gray)
                    
                    AnswerRow(answer: Answer(text: "king Fahad", isCorrect: false))
                    AnswerRow2(answer: Answer(text: "king Salman", isCorrect: true))
                    AnswerRow3(answer: Answer(text: "king Khalid", isCorrect: false))
                    AnswerRow4(answer: Answer(text: "king Faisal.", isCorrect: false))
                }
            }
            .padding()
...
//            .background(Color.white)
            ...
            .background(
                NavigationLink("", destination: QuestionView10(), isActive: $navigateToQuestion2)
            )
