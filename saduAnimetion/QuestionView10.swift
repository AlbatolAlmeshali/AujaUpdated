...
//                        .fontWeight(.bold)
                ...
                VStack(alignment: .center, spacing: 20) {
                    Text("10 out of 10")
                        ...
                        .fontWeight(.heavy)
                    Text("What is the type of the Saudi regime?")
                        .font(.system(size: 20))
                        .bold()
                        .foregroundColor(.gray)
                
                    AnswerRow(answer: Answer(text: "Monarchy", isCorrect: true))
                    AnswerRow2(answer: Answer(text: "dictatorial", isCorrect: false))
                    AnswerRow3(answer: Answer(text: "totalitarian", isCorrect: false))
                    AnswerRow4(answer: Answer(text: "absolutist", isCorrect: false))
                }
            }
            .padding()
...
//            .background(Color(red: 0.984313725490196, green: 0.9294117647058824, blue: 0.8470588235294118))
           // .background(Color.white)
            ...
            .background(
                NavigationLink("", destination: RankPage(), isActive: $navigateToQuestion2)
            )
