...
//                        .fontWeight(.bold)
                ...
                ProgressBar(progress: 140)
                VStack(alignment: .center, spacing: 20) {
                    Text("4 out of 10")
                        .foregroundColor(Color("AccentColor"))
                        .fontWeight(.heavy)
                    Text("What is the highest peak in Saudi Arabia?")
                        .font(.system(size: 20))
                        .bold()
                        .foregroundColor(.gray)
            
                    AnswerRow(answer: Answer(text: "Jabal Al-Laws", isCorrect: false))
                    AnswerRow2(answer: Answer(text: "Jabal Abu Qubays", isCorrect: false))
                    AnswerRow3(answer: Answer(text: "Alsouda mountains", isCorrect: true))
                    AnswerRow4(answer: Answer(text: "Jeshan mountains", isCorrect: false))
                }
            }
            .padding()
...
//            .background(Color.white)
            ...
            .background(
                NavigationLink("", destination: QuestionView5(), isActive: $navigateToQuestion2)
            )
