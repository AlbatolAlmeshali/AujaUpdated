...
//                        .fontWeight(.bold)
                ...
                VStack(alignment: .center, spacing: 20) {
                    Text("5 out of 10")
                        ...
                        .fontWeight(.heavy)
                    Text("What is the name of the famous Saudi poet who wrote the Saudi National Anthem?")
                        .font(.system(size: 20))
                        .bold()
                        .foregroundColor(.gray)
                   

                    AnswerRow(answer: Answer(text: "Mohammed Abdu.", isCorrect: false))
                    AnswerRow2(answer: Answer(text: "Adieb Roomy", isCorrect: false))
                    AnswerRow3(answer: Answer(text: "Ibrahim Khfagy", isCorrect: true))
                    AnswerRow4(answer: Answer(text: "Ali Alhosaini", isCorrect: false))
                }
            }
            .padding()
...
//            .background(Color.white)
            ...
            .background(
                NavigationLink("", destination: QuestionView6(), isActive: $navigateToQuestion2)
            )
